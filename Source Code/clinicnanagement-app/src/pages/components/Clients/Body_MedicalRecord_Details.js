...
import { GetPrescriptionervices } from '../../../api/prescriptionServices';
...
export const BodyContent = () => {
    ...
    const getMedicalReport = async () => {
        const id = sessionStorage.getItem('medicalReportID');
        const req = await GetMedicalReportServices(id);
        setData(req)
    }
...
export const PrescriptionContent = () => {
    ...
    const getMedicalReport = async () => {
        ...
        const req = await GetPrescriptionervices(id);
        setData(req)
    }
