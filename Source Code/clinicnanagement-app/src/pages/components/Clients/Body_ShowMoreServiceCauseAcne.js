...
import imageContent1 from '../../../assets/images/image_content_causeacne.jpg';
import { Button, Card, CardActionArea, CardActions, CardContent, CardMedia, Typography } from '@mui/material';
import Skeleton from '@mui/material/Skeleton';
import Grid2 from '@mui/material/Unstable_Grid2/Grid2';
import 'slick-carousel/slick/slick-theme.css';
import imageServiceCauseAcne1 from '../../../assets/images/serviceCauseAcne1.jpg';
import imageServiceCauseAcne2 from '../../../assets/images/serviceCauseAcne2.jpg';
import imageServiceCauseAcne3 from '../../../assets/images/serviceCauseAcne3.jpg';
...
const serviceCauseAcneData = [
    {
        img: imageServiceCauseAcne1,
        title: "Papules",
        content: "Meet your perfect match, coverage & finish with the help of Clinique’s Shade Match Science",

    },
    {
        img: imageServiceCauseAcne2,
        title: "Acne",
        content: "Meet your perfect match, coverage & finish with the help of Clinique’s Shade Match Science",

    },
    {
        img: imageServiceCauseAcne3,
        title: "Nodules",
        content: "Meet your perfect match, coverage & finish with the help of Clinique’s Shade Match Science",
        ...
        >
            ...
            >
                <Grid2>
                    ...
                    >
                        {serviceCauseAcneData.map((image) => (
                            <Card
                                key={image.img}
                                sx={{
