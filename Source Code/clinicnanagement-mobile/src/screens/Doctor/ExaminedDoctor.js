...
const ExaminedDoctor = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.Header}>
          <Text style={styles.Text}>The Patient Examined</Text>
        </View>
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.medical}>
              ...
              <View style={styles.text_medical_header}>
                <Text style={styles.txt_medical_Title}>Nguyen Van A</Text>
              ...
              <View style={styles.text_medical}>
                ...
                <View style={styles.txt_medical_content}>
                  <Text>Time</Text>
                  <Text style={styles.txt_medical}>11:00 am</Text>
                </View>
              </View>
              ...
              <View style={styles.Notification_medical}>
                 <View style={styles.medicalComplete}>
                  <View>
                    <Text>Disease: </Text>
                    <Text style={styles.txt_medical}>Nodules</Text>
                  </View>
                </View> 
