          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.medical}>
              ...
              <View style={styles.text_medical}>
                <View>
                  <Text>Report</Text>
                  <Text style={styles.txt_medical}>Report From Doctor</Text>
                </View>
                <View style={styles.txt_medical_content_doctor}>
                  <Text>Disease</Text>
              ...
              <View style={styles.Notification_medical}>
                <View style={styles.medicalComplete}>
                  <View>
                    <Text>Date </Text>
                    <Text style={styles.txt_medical}>28/04/2023</Text>
                  </View>
                </View>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    navigation.navigate("MedicalreportDoctor");
                  }}
                >
            ...
            <View style={styles.medical}>
              ...
              <View style={styles.text_medical}>
                <View>
                  <Text>Report</Text>
                  <Text style={styles.txt_medical}>Report From AI</Text>
                </View>
                <View style={styles.txt_medical_content_doctor}>
                  <Text>Disease</Text>
                  <Text style={styles.txt_medical}>Atopic Dermatitis</Text>
