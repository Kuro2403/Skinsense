        ...
        <View style={{ flex: 1 }}>
          <View style={styles.BodyAcne}>
            <View style={styles.TextBody}>
              <Text style={styles.Txt_Tittle}>Cyst</Text>
              <Text style={styles.txt_content}>
                Cystic acne is a type of inflammatory acne that causes painful,
                pus-filled pimples to form deep under the skin. Acne occurs when
                oil and dead skin cells clog skin pores.
              </Text>
            </View>
          ...
          <View style={styles.ImgAcneHeader}>
            <Image source={ImgCyst} resizeMode="stretch" />
          </View>
        </View>
      </ImageBackground>
    </ScrollView>
